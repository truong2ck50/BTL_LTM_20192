...
namespace Gamecaro
{
    public class ChessBoardManager
    {
        ...
        public ChessBoardManager(Panel chessBoard, TextBox playerName, PictureBox mark)
        {
            ...
            {
                new Player("Player1", Image.FromFile(Application.StartupPath + "\\Resources\\O_image.png")),
                new Player("Player2", Image.FromFile(Application.StartupPath + "\\Resources\\X_image.png"))
            };
